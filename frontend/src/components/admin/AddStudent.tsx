...
import axios from "axios";
import { useNavigate } from "react-router-dom";
import { FaUser, FaEnvelope, FaPhone, FaGlobe, FaBook, FaVenusMars, FaCalendarAlt, FaLock, FaBuilding, FaCalendar } from "react-icons/fa";
...
const AddStudent: React.FC = () => {
  ...
  const confirmSubmission = async () => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/api/addStudent`, formattedData);
      setShowSuccessToast(true);
      setStudInfo({
        studId: "",
        studName: "",
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-3xl w-full bg-white rounded-xl shadow-lg p-8 transform transition-all hover:shadow-2xl">
        <h1 className="text-3xl font-bold text-blue-800 mb-8 text-center">Add New University Student</h1>
        {loading ? (
          <div className="flex justify-center items-center">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-600"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="studId" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaUser className="mr-2 text-blue-600" /> Student ID
                </label>
                <input
                  id="studId"
                  ...
                  value={studInfo.studId}
                  onChange={handleChange}
                  placeholder="Enter unique student ID (e.g., U001)"
                  required
                />
                {errors.studId && <p className="text-red-500 text-sm mt-1">{errors.studId}</p>}
              </div>
              <div>
                <label htmlFor="studName" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaUser className="mr-2 text-blue-600" /> Student Name
                </label>
                <input
                  id="studName"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="region" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaGlobe className="mr-2 text-blue-600" /> Region
                </label>
                <select
                  id="region"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="batch" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaCalendar className="mr-2 text-blue-600" /> Batch (Year)
                </label>
                <select
                  id="batch"
                ...
                {studInfo.batch === "Other" && (
                  <div className="mt-2">
                    <input
                      ...
                      value={customBatch}
                      onChange={handleCustomBatchChange}
                      placeholder="Enter custom batch (e.g., 2012 E.C.)"
                      required
                    />
                    {errors.customBatch && <p className="text-red-500 text-sm mt-1">{errors.customBatch}</p>}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="semester" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaCalendar className="mr-2 text-blue-600" /> Semester
                </label>
                <select
                  id="semester"
              ...
              <div>
                <label htmlFor="gradeLevel" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaBook className="mr-2 text-blue-600" /> Year Level
                </label>
                <select
                  id="gradeLevel"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="enrolledCourses" className="block text-sm font-medium text-gray-700 flex items-center">
                  <FaBook className="mr-2 text-blue-600" /> Enrolled Courses
                </label>
                <select
                  id="enrolledCourses"
            ...
            <div>
              <label htmlFor="registrationDate" className="block text-sm font-medium text-gray-700 flex items-center">
                <FaCalendarAlt className="mr-2 text-blue-600" /> Registration Date
              </label>
              <DatePicker
                id="registrationDate"
